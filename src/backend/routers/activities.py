...
def get_activities(
    ...
    - difficulty: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced'). Activities
      with no difficulty set are always included since they are open to all levels.
    """
    ...
    if difficulty:
        # Include activities matching the requested difficulty OR those with no difficulty set
        query["$or"] = [
